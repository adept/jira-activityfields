...
{
    private static final Logger log = Logger.getLogger(NextWeekActivityCFType.class);
    ...
    public Object getValueFromIssue(CustomField field, Issue issue)
    {
        ...
        try
        {
        	...
        	final List<Issue> issues = getIssues(issue, "((due >= 0 and due <= 1w) or due is empty) AND resolution is empty ORDER BY key DESC");
